...
$bridgeSource = Join-Path $projectRoot 'fabric-bridge\build\libs\minecraft-ai-fabric-bridge-1.3.0-gamma.jar'
$bridgeTarget = Join-Path $modsDirectory 'minecraft-ai-fabric-bridge-1.3.0-gamma.jar'
