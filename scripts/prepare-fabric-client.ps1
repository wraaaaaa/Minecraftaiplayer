...
$bridgeSource = Join-Path $projectRoot 'fabric-bridge\build\libs\minecraft-ai-fabric-bridge-1.2.0.jar'
$bridgeTarget = Join-Path $modsDirectory 'minecraft-ai-fabric-bridge-1.2.0.jar'
